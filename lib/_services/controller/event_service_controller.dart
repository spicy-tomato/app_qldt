...
class EventServiceController extends ServiceController<LocalEventService, ApiEventService> {
  ...
  Map<DateTime, List<UserEventModel>> get calendarData =>
      localService.calendarData;
  ...
  Future<void> refresh() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (response.statusCode == 204) {
        ...
        print('Error with status code: ${response
            .statusCode} at event_service_controller.dart');
      }
    }
  }
  ...
  Future<void> saveAllModifiedScheduleWithName(String eventName,
      EventScheduleModel event) async {
